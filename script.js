...
const translations = {
    ua: {
        ...
        snowdrop: "Підсніжник",
        snowdropText: "Ніжний та чистий, наче перший сніг. Прокидається щовесни, даруючи надію.",
        winterAconite: "Шафран",
        winterAconiteText: "Яскравий та сміливий. Пробивається крізь сніг, розфарбовуючи весну.",
        liverleaf: "Білоцвіт весняний",
        liverleafText: "Білий вісник весни. Тендітний та витончений, як перші промені сонця.",
    ...
    en: {
        ...
        snowdrop: "Snowdrop",
        snowdropText: "Gentle and pure like the first snow. Wakes up every spring, giving hope.",
        winterAconite: "Saffron",
        winterAconiteText: "Bright and brave. Breaks through the snow, coloring spring.",
        liverleaf: "Spring Snowflake",
        liverleafText: "White herald of spring. Delicate and graceful like first rays of sun.",
